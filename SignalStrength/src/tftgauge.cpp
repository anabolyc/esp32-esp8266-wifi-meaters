...
void TFTGauge::drawArrow(int16_t value, uint32_t color)
{
...
void TFTGauge::drawValue(int16_t value, uint32_t color)
{
...
void TFTGauge::set(int16_t value)
{
    if (value == prev_value)
        return;
